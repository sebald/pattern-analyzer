import { Card, Container, List } from 'components';
    ...
    <Container>
      <div className="grid min-h-screen place-items-center">
        <div className="flex flex-col items-center">
          <h1
            className={`${montserrat.className} prose flex items-center pb-12 text-2xl font-extrabold uppercase text-primary-900`}
          >
            <svg
