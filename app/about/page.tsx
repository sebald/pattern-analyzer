import { Container, Headline, Link, List, Text, Title } from '@/ui';
  ...
  <main className="pt-10 pb-6 text-secondary-900 md:pt-16">
    <Container size="narrow">
      ...
      <Text size="large" prose>
        ...
        tournament page and uploaded to Listfortress. However, with the
        sunsetting of TTO and the switch to Longshanks, there is currently no
        way to export the tournament data from Longshanks. This means a chunk of
        the tournament data is missing from Listfortress.
      </Text>
      <Text size="large" prose>
      ...
      <Text size="large" prose>
        Pattern Analyzer crawls the vendor website (Longshanks, Rollbetter, …)
        for information. Sometimes it might use an API of the site, other times
        it uses the same website you are seeing when visiting the event page. In
        the later case, Pattern Analyzer goes through the source code and
