    ...
    <Radix.Root defaultValue={defaultTab}>
      ...
      >
        {labels.map(({ id, content }) => (
          <Radix.Trigger
            className={[
              'flex flex-1 cursor-pointer items-center justify-center gap-2 rounded-lg bg-primary-100 px-24 py-2 text-primary-500 hover:bg-primary-200 hover:text-primary-800 lg:flex-initial',
