...
import { Calendar, Map, User } from '@/ui/icons';
...
const Property = ({ label, value }: PropertyProps) => (
  <div className="col-span-full grid grid-cols-subgrid items-baseline text-sm leading-tight">
