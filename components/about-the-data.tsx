import { Headline, List, Text } from 'components';
...
export const AboutTheData = () => (
  <>
    ...
    <Text>
      ...
      statistics. In other cases they will show up as “unknown” to indicate how
      much of the information could be used to generate the statistic.
    </Text>
