...
export const HeadlineSkeleton = ({ className }: { className?: string }) => (
  <div
    className={cn('mb-2 h-3 w-3/5 rounded-xl bg-secondary-200', className)}
  />
);
...
export const ChartSkeleton = () => (
  <div className="flex h-64 items-center justify-center rounded bg-secondary-100 text-secondary-300">
    <svg
