...
const TimelineItem = ({ children }: TimelineItemProps) => (
  <div className="flex flex-col gap-x-12 gap-y-6 md:flex-row lg:gap-x-20">
    {children}
  </div>
);
...
const TimelineHeader = ({ children }: TimelineHeaderProps) => (
  <div className="mt-1.5 text-sm font-medium leading-none md:mt-0 md:w-32 md:text-base lg:w-36">
...
export const Timeline = ({ children }: TimelineProps) => {
  return (
    <div className="relative ml-4 flex flex-col gap-14 border-l-2 border-primary-300 py-2 pl-4 lg:gap-20">
      {children}
    </div>
  );
};
